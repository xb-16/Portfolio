  ...
  const skills = [
    ...
    },
    {
      ...
      items: [
        ...
        "Design Kit (shadcn/ui, Tailwind CSS, Lucide React, Framer Motion)",
    ...
    },
    {
      ...
      items: [
        "Queues & Jobs (Horizon)",
        "Debugging & Monitoring (Telescope)",
        "Spatie (Role-Permission, Query Builder)",
        "Authentication (Sanctum)",
        "Scout (Full-text Search)",
        "Postman",
        "Code Quality (Pint, Larastan)",
        "Scramble (API Documentation)",
        "Octane (high-performance apps)",
      ],
    },
    {
      category: "Python",
    ...
    },
    {
      ...
      items: [
        "MySQL (Optimization)",
        "PL‑SQL (Transactions, Triggers...)",
        "NoSQL (MongoDB, Replication & Sharding)",
      ],
    },
    {
      ...
      items: [
        ...
        "Linux (process management, networking, bash scripting)",
    ...
    },
    {
      ...
      items: [
        ...
        "Switching, Routing",
        "Web Application Security (CORS, CSP, OWASP basics)",
      ],
    },
    {
      category: "AI & ML",
      items: [
        "Machine Learning",
        "LLMs",
        "Agentic Coding (Skills, Rules & Workflows)",
        "Prompt Engineering",
        "Claude Code",
      ],
    },
          ...
          >
            ...
            <ul className="space-y-1.5">
              {skill.items.map((item, idx) => (
                <li key={idx} className="flex items-start gap-2 text-sm text-[var(--sea-ink-soft)] dark:text-white/80">
                  <span className="mt-1.5 h-1 w-1 rounded-full bg-[var(--lagoon)] flex-shrink-0" />
